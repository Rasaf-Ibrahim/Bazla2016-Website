    ...
    <div class="max-w-98% sm:max-w-90% md:max-w-75%  mx-auto
        ...
        <div v-for="student in filteredStudents" :key="student.firebase_id"
             ...
             bg-dark-2_r hover-bg-dark-3_r transition_r">
              ...
              <span class="mx-6  
                  heading-4_r 
                  col-span-4 md:col-span-2 md:justify-self-center">
                  {{student.id}}
            </span>
            ...
            <span class="mx-6  
                  heading-4_r 
                  col-span-8  md:col-span-8 md:justify-self-center">
                  {{student.name}}
            </span>
...
<script> 
 import { database } from '../../firebaseConfig';
    ...
    countStudents(){
      database.collection("info").get().then(function(querySnapshot) {      
